...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Template CSS -->
        <link rel="stylesheet" href="assets/css/main.css@v=3.2.css" />
    </head>
                ...
                <div class="container">
                    <div class="header-wrap">
                        <div class="logo logo-width-1">
                            <a href="index.html"><img src="assets/imgs/theme/Icon.png" style="object-fit: contain" height="50px" alt="logo" /></a>
                        </div>
                        <div class="header-right">
                            <div class="search-style-2">
                                <form action="page-login.html#">
                                    <input type="text" style="max-width: none; width: 100%" placeholder="Search for items..." />
                                </form>
                            </div>
                    ...
                    <div class="header-wrap header-space-between position-relative">
                        ...
                        <div class="header-nav d-none d-lg-flex">
                            <div class="main-categori-wrap d-none d-lg-block">
                                <a class="categories-button-active" href="page-login.html#">
                        ...
                        <div class="col-lg-12">
                            <div class="position-relative newsletter-inner">
                                <div class="newsletter-content">
                                    ...
                                    <p class="mb-45">Start You'r Daily Shopping with <span class="text-brand">Watcher</span></p>
                                    <form class="form-subcriber d-flex">
                                        <input type="email" placeholder="Your emaill address" />
                                        <button class="btn" type="submit">Subscribe</button>
                                    </form>
                                </div>
                                <img src="https://static.wixstatic.com/media/2cd43b_70674f11a01e43f19366ee72aee4b8bb~mv2.png/v1/fill/w_320,h_507,q_90/2cd43b_70674f11a01e43f19366ee72aee4b8bb~mv2.png" alt="newsletter" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                                <div class="logo mb-30">
                                    <a href="index.html" class="mb-15"><img src="assets/imgs/theme/Icon.png" style="object-fit: contain" height="50px" alt="logo" /></a>
                                    <p class="font-lg text-heading">Tempat Jual Beli Jam</p>
                                </div>
                                <ul class="contact-infor">
                                    <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>Indonesia</span></li>
                                    <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us: </strong><span>08123456789</span></li>
                                    <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email: </strong><span>watcher@gmail.com</span></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="footer-link-widget widget-install-app col">
                            ...
                            <div class="download-app">
                                <a href="page-login.html#" class="hover-up mb-sm-2 mb-lg-0"><img class="active" src="assets/imgs/theme/app-store.jpg" alt="" /></a>
                                <a href="page-login.html#" class="hover-up mb-sm-2"><img src="assets/imgs/theme/google-play.jpg" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container pb-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <p class="font-sm mb-0">&copy; 2021, <strong class="text-brand">Watcher</strong> <br />All rights reserved</p>
                    </div>
